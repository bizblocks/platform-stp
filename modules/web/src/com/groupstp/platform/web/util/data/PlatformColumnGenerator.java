package com.groupstp.platform.web.util.data;
 ...
 * @author adiatullin
 */
public final class PlatformColumnGenerator<T extends Entity> implements Serializable {
    ...
    public PlatformColumnGenerator(Table.ColumnGenerator<T> generator) {
        this(generator, generator);
    }

    public PlatformColumnGenerator(Table.ColumnGenerator<T> readGenerator, Table.ColumnGenerator<T> editGenerator) {
