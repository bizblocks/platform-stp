...
public class PlstpTestContainer extends TestContainer {

    public PlstpTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/groupstp/platform/app.properties",
    ...
    public static class Common extends PlstpTestContainer {

        public static final PlstpTestContainer.Common INSTANCE = new PlstpTestContainer.Common();
